...
@Repository
public interface VacuumRepository extends JpaRepository<Vacuum, Integer>, JpaSpecificationExecutor<Vacuum> {
    default Specification<Vacuum> hasDeviceName(String deviceName) {
    ...
    default Specification<Vacuum> hasCountry(String country) {
        return (root, query, criteriaBuilder) -> {
    ...
    default Specification<Vacuum> hasManufacturer(String manufacturer) {
        return (root, query, criteriaBuilder) -> {
    ...
    default Specification<Vacuum> combinedSpecification(String deviceName, String country, String manufacturer) {
        Specification<Vacuum> result = Specification.where(null);
