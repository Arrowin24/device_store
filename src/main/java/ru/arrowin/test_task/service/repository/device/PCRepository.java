...
public interface PCRepository extends JpaRepository<PC, Integer>, JpaSpecificationExecutor<PC> {
    default Specification<PC> hasDeviceName(String deviceName) {
    ...
    default Specification<PC> hasCountry(String country) {
        return (root, query, criteriaBuilder) -> {
    ...
    default Specification<PC> hasManufacturer(String manufacturer) {
        return (root, query, criteriaBuilder) -> {
    ...
    default Specification<PC> combinedSpecification(String deviceName, String country, String manufacturer) {
        Specification<PC> result = Specification.where(null);
